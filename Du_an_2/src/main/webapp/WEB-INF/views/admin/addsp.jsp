	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="container">
					<h1 style="font-weight: bold; color: red; margin-left: 350px">Thêm
						Sản Phẩm</h1>
					<form:form action="/admin/dashboard/add" method="post"
						modelAttribute="ct" enctype="multipart/form-data">
						<div>
						...
						<div>
							...
							<form:select path="hang" class="form-select"
								aria-label="Default select example">
						...
						<div>
							...
							<form:select path="mauSac" class="form-select"
								aria-label="Default select example">
								<form:options items="${listMauSac}" itemValue="id"
									itemLabel="ten" />
							</form:select>
						</div>
						<div>
							<label class="form-label">Nhà Cung Cấp</label>
							<form:select path="nhaCungCap" class="form-select"
								aria-label="Default select example">
						...
						<div>
							...
							<form:select path="chatLieu" class="form-select"
								aria-label="Default select example">
								<form:options items="${listChatLieu}" itemLabel="ten"
									itemValue="id" />
							</form:select>
						</div>
						<div>
						...
						<br>
						<div>
							<input type="file" name="anh" id="file" class="inputfile" /> <label
								for="file">Thêm ảnh</label>
						</div>
