...
<body class="sub_page">
					...
					<nav class="navbar navbar-expand-lg custom_nav-container ">
						...
						<div class="collapse navbar-collapse" id="navbarSupportedContent">
							<ul class="navbar-nav ">
								...
								<li class="nav-item"><a class="nav-link"
									href="/sneaker/hoa-don">Bán hàng</a></li>
							</ul>
						</div>
					</nav>
				</div>
	...
	<section style="margin-top: 100px">
        ...
        <button class="btn btn-primary">Tạo hóa đơn</button>
				...
				<a class="btn btn-success" href="/sneaker/hoa-don/tao-hoa-don">Tạo
					hóa đơn</a>
			</div>
			<div class="card">
				<table class="table table-hover">
					...
					<tbody>
						<c:forEach items="${listHD.content}" var="hd" varStatus="stt">
							<tr>
								<td>${stt.index + 1}</td>
								<td>${hd.ma}</td>
								...
								<td><a type="button" href="sneaker/hoa-don/delete/${hd.id}"
									class="btn btn-danger"><i class="fa fa-trash"></i></a> <a
									type="button" href="/sneaker/edit_hoadon/${hd.id}"
				...
				<nav style="font-weight: bold;" aria-label="Page navigation example">
					<ul class="pagination">
						<c:if test="${inputsearch != null || inputsearch != ''}">
							<c:forEach begin="0" end="${ listHD.totalPages -1}"
								varStatus="loop">
								<li class="page-item"><a style="color: red"
									class="page-link"
									href="/sneaker/hoadon/search?inputsearch=${inputsearch}&page=${loop.begin + loop.count - 1}">
